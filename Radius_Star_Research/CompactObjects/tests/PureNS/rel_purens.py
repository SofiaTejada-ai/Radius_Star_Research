...
# Calculate Mass vs Radius for Newton and TOV cases
...
axes[0].set_xlabel('r [km]', fontsize=10)
axes[0].set_ylabel(r'P [$dyne/cm^2$]', fontsize=10)
axes[0].minorticks_on()
axes[0].set_title("P(r) of a pure neutron star")
...
axes[1].set_ylabel(r"m [$M_{\odot}$]", fontsize=10)
axes[1].minorticks_on()
axes[1].set_title("m(r) of a pure neutron star")
...
axes[2].set_xlabel('R [km]', fontsize=10)
axes[2].set_ylabel(r"M [$M_{\odot}$]", fontsize=10)
axes[2].minorticks_on()
axes[2].set_title("Mass-Radius of a pure neutron star")

fig.tight_layout()

# Save or display the plot
plt.savefig(results_dir + 'combined_plots.pdf', format='pdf', dpi=1000)
plt.show()
